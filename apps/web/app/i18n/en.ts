...
export const en = {
  ...
  amidakuji: {
    ...
    howtoItems: [
      ...
      '📋 "Bulk entry" mode adds multiple names at once, one per line.',
      '👥 From 2 up to a maximum of 12 participants can join.',
      ...
      '🔁 Press "Redraw" to shuffle the ladder again with the same members.',
    ...
    widget: {
      ...
      maxCountError: 'Up to 12 participants can join.',
      durationLabel: 'Duration:',
      durationNone: 'None',
      durationSeconds: (n) => (n === 1 ? '1 second' : `${n} seconds`),
