 ...
 * OS のネイティブ共有ボタンも表示する。
 */
export default function ShareButtons({ text, hashtags = [], disabled = false }: Props) {
  ...
  return (
    <div className="share-area">
      ...
      >
        ...
        <span aria-live="polite">{copied ? 'コピーしました' : 'リンクをコピー'}</span>
      </button>
